...
[![Vue.js](https://img.shields.io/badge/using-Vue.js-brightgreen.svg)](https://vuejs.org/index.html)
[![Amber Framework](https://img.shields.io/badge/using-amber_framework-orange.svg)](https://amberframework.org)

This is a project written using [Vue.js](https://vuejs.org/index.html) and [Amber](https://amberframework.org). Enjoy!
...
4. Start Amber server and Webpack with `bin/amber watch`
