...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Fake App web application."
  #
  #
  ...
  #
  # settings.secret_key_base= Og2cjIjH9WuuDE5d4JlxdXdvlVYjQfbGPSo-urfyrZM
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("fake_app.log", "w"))
  #
  #
end
